  ...
  return (
    <main className="mt-12 flex h-full w-full justify-center px-6">
      <div className="flex h-full w-full max-w-screen-lg flex-col items-start justify-center">
        <p className="text-app-yellow-800 text-9xl font-bold">404...</p>
        ...
        <Link
          href="/"
          className="hover:bg-app-blue-400 ml-auto mr-auto mt-16 rounded bg-app-blue-500 px-4 py-3 font-semibold uppercase text-app-grey-100"
        >
          Return Home
        </Link>
      </div>
